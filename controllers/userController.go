...
import (
	...
	database "github.com/pi-prakhar/jwt-auth-go/database"
	helper "github.com/pi-prakhar/jwt-auth-go/helpers"
	models "github.com/pi-prakhar/jwt-auth-go/models"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		countByPhoneNumber, err := userCollection.CountDocuments(ctx, bson.M{"phone": user.Phone})
		defer cancel()
		if err != nil {
			log.Panic(err)
		...
		if (countByEmail > 0) || (countByPhoneNumber > 0) {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "this mail or phone number "})
			return
		}
...
func GetUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Use the parsed startIndex in your code as needed
